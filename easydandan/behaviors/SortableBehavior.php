...
use Yii;
class SortableBehavior extends \yii\base\Behavior{
    public $model;
    public function move($id, $direction, $condition = [])
    {
        ...
        if (($model = $modelClass::findOne($id))) {
            ...
            if (!empty($modelSwap)) {
                ...
                $success = ['swap_id' => $modelSwap->primaryKey,'message'=>'change success'];
            }
        } else {
            $this->owner->error = Yii::t('easydandan', 'Not found');
        }
